...
public class HostAndPortUtil
{
  ...
  static
  {
    redisHostAndPortList.add( new HostAndPort( "localhost", DEFAULT_PORT ) );
    redisHostAndPortList.add( new HostAndPort( "localhost", DEFAULT_PORT + 1 ) );
    redisHostAndPortList.add( new HostAndPort( "localhost", DEFAULT_PORT + 2 ) );
    redisHostAndPortList.add( new HostAndPort( "localhost", DEFAULT_PORT + 3 ) );
    redisHostAndPortList.add( new HostAndPort( "localhost", DEFAULT_PORT + 4 ) );
    redisHostAndPortList.add( new HostAndPort( "localhost", DEFAULT_PORT + 5 ) );

    sentinelHostAndPortList.add( new HostAndPort( "localhost", Protocol.DEFAULT_SENTINEL_PORT ) );
    sentinelHostAndPortList.add( new HostAndPort( "localhost", Protocol.DEFAULT_SENTINEL_PORT + 1 ) );
    sentinelHostAndPortList.add( new HostAndPort( "localhost", Protocol.DEFAULT_SENTINEL_PORT + 2 ) );

    clusterHostAndPortList.add( new HostAndPort( "localhost", DEFAULT_PORT ) );
    clusterHostAndPortList.add( new HostAndPort( "localhost", DEFAULT_PORT + 1 ) );
    clusterHostAndPortList.add( new HostAndPort( "localhost", DEFAULT_PORT + 2 ) );
    clusterHostAndPortList.add( new HostAndPort( "localhost", DEFAULT_PORT + 3 ) );
    clusterHostAndPortList.add( new HostAndPort( "localhost", DEFAULT_PORT + 4 ) );
    clusterHostAndPortList.add( new HostAndPort( "localhost", DEFAULT_PORT + 5 ) );
